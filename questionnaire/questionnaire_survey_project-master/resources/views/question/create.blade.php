                    ...
                    <form action="/questionnaire/{{$questionnaire->id}}/questions" method="post">
                        ...
                        <div class="form-group">
                            <fieldset>
                                ...
                                <small id="choicesHelp" class="form-text text-muted">Get choices that give you the most insight into your question.</small>
                                <div>
                                    <div class="form-group">
                                        <label for="answer1">Choice 1</label>
                                        <input name="answers[][answer]" type="text" class="form-control" id="answer1" aria-describedby="choicesHelp" placeholder="Enter Choice 1"
